...
export default function CourseSidebar({
  ...
  return (
    <aside className="w-full md:w-72 flex-shrink-0 bg-background-secondary border-b md:border-b-0 md:border-r border-border flex flex-col h-auto max-h-[40vh] md:max-h-none md:h-full overflow-y-auto custom-scrollbar overscroll-none md:sticky top-18 z-20">
